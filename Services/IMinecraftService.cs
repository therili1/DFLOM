...
namespace Launcher.Services
{
    public interface IMinecraftService
    {
        ...
        /// <summary>Список доступних версій лоадера (Fabric/Quilt/Forge/NeoForge) для конкретної
        /// версії Minecraft, найновіша перша. Порожній список для "Vanilla" або якщо не вдалось
        /// отримати дані (мережева помилка) - виклик має падати м'яко, UI покаже "лише авто".</summary>
        Task<List<string>> GetLoaderVersionsAsync(string loader, string mcVersion, CancellationToken cancellationToken = default);
