...
namespace Launcher.ViewModels
{
    public partial class InstancesViewModel : ObservableObject
    {
        ...
        // Порожній рядок = "остання/автоматична версія" (та сама поведінка, що й раніше).
        [ObservableProperty]
        private string _newProfileLoaderVersion = string.Empty;
        ...
        public ObservableCollection<string> AvailableLoaders { get; } = new() { "Vanilla", "Fabric", "Forge", "Quilt", "NeoForge" };
        ...
        /// <summary>Тонка обгортка над IMinecraftService для діалогу створення профілю -
        /// список версій обраного лоадера для обраної версії Minecraft.</summary>
        public Task<List<string>> GetLoaderVersionsAsync(string loader, string mcVersion) =>
            _minecraftService.GetLoaderVersionsAsync(loader, mcVersion);
        ...
        public async Task CreateInstanceAsync()
        {
            ...
            var newInst = new MinecraftInstance
            {
                ...
                // Порожній LoaderVersion = "автоматично найновіша" (як і раніше); якщо
                // користувач обрав конкретну версію лоадера в діалозі - передаємо її.
                LoaderVersion = NewProfileLoaderVersion
            };
            ...
            NewProfileLoaderVersion = string.Empty;
            NewProfileRam = 4096;
